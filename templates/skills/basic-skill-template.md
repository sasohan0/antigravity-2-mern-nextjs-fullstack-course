...
description: Use this skill when a specific reusable development task. Do not use it for unrelated tasks or broad full-project rewrites.
---
...
## When to use
- When the project needs a specific reusable development task.
...
## Example prompt
Use this skill to review `[file list]` for `a specific reusable development task`. Do not edit code until the review is complete.
