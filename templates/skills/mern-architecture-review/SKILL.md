...
description: Use this skill when reviewing MERN architecture, folder structure, data flow, auth flow and implementation plans. Do not use it for unrelated tasks or broad full-project rewrites.
---
...
## When to use
- When the project needs reviewing MERN architecture, folder structure, data flow, auth flow and implementation plans.
...
## Example prompt
Use this skill to review `[file list]` for `reviewing MERN architecture, folder structure, data flow, auth flow and implementation plans`. Do not edit code until the review is complete.
