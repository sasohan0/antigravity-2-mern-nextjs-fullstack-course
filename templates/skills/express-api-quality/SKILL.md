...
description: Use this skill when reviewing Express routes, controllers, services, validation, auth and error handling. Do not use it for unrelated tasks or broad full-project rewrites.
---
...
## When to use
- When the project needs reviewing Express routes, controllers, services, validation, auth and error handling.
...
## Example prompt
Use this skill to review `[file list]` for `reviewing Express routes, controllers, services, validation, auth and error handling`. Do not edit code until the review is complete.
