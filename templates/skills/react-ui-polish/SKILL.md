...
description: Use this skill when reviewing React/Tailwind UI quality, responsiveness, visual hierarchy and states. Do not use it for unrelated tasks or broad full-project rewrites.
---
...
## When to use
- When the project needs reviewing React/Tailwind UI quality, responsiveness, visual hierarchy and states.
...
## Example prompt
Use this skill to review `[file list]` for `reviewing React/Tailwind UI quality, responsiveness, visual hierarchy and states`. Do not edit code until the review is complete.
