...
description: Use this skill when reviewing Next.js App Router architecture, server/client boundaries and route strategy. Do not use it for unrelated tasks or broad full-project rewrites.
---
...
## When to use
- When the project needs reviewing Next.js App Router architecture, server/client boundaries and route strategy.
...
## Example prompt
Use this skill to review `[file list]` for `reviewing Next.js App Router architecture, server/client boundaries and route strategy`. Do not edit code until the review is complete.
