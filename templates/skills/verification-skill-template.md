---
name: verification-skill-template
description: Use this skill when evidence-based verification. Do not use it for unrelated tasks or broad full-project rewrites.
---
...
## When to use
- When the project needs evidence-based verification.
...
## Example prompt
Use this skill to review `[file list]` for `evidence-based verification`. Do not edit code until the review is complete.
