---
name: review-skill-template
description: Use this skill when senior review of a focused area. Do not use it for unrelated tasks or broad full-project rewrites.
---
...
## When to use
- When the project needs senior review of a focused area.
...
## Example prompt
Use this skill to review `[file list]` for `senior review of a focused area`. Do not edit code until the review is complete.
