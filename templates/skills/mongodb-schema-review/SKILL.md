...
description: Use this skill when reviewing MongoDB/Mongoose schemas, relationships, validation and indexes. Do not use it for unrelated tasks or broad full-project rewrites.
---
...
## When to use
- When the project needs reviewing MongoDB/Mongoose schemas, relationships, validation and indexes.
...
## Example prompt
Use this skill to review `[file list]` for `reviewing MongoDB/Mongoose schemas, relationships, validation and indexes`. Do not edit code until the review is complete.
